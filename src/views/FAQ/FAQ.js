	...
	return (
				...
				<main className="accordion__div">
					...
					<Accordion
						...
						content="
								<p>A modern approach to building your community, ReVitalize is a crowdfunding platform that creates apprenticeship
								opportunities to develop your skills to gain licensing.</p>"
					/>
					<Accordion
						title="How do I get involved?"
						content="
								<p>First you are going to want to register with ReVitalize.
